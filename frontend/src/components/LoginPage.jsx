...
const LoginPage = () => {
    ...
    return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#CBEAF6] to-[#FFFFFF] font-serif">
        <div className="w-full max-w-md p-8 space-y-8 bg-[#008080] rounded-2xl shadow-lg">
